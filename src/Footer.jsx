  ...
  return (
    <footer className="max-w-7xl mx-auto  px-10 py-8">
      <div className="flex justify-between items-center gap-32">
        ...
        {/* RIGHT */}
        <div className="flex mt-32 gap-14 select-none">
      ...
      <img className="w-24 bg-blue-500 px-6 py-2" src="https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63349803431f1562dccf1802_refokus%20logo.svg" alt="" />
